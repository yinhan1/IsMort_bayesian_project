...
posterior_dist <-
  read.csv("../data/posterior_co_random_initial.csv.csv")[-1,] %>%
  burn_n_thin_draws(jump = 200, burn_at = 5000)

posterior_dist <- outcomes %>% burn_n_thin_draws(jump = 200, burn_at = 5000) %>% as.data.frame()
```
