...
posterior_dist <- read.csv("../data/posterior_control_2020-04-14.csv") %>% burn_n_thin_draws(jump = 220, burn_at = 1)
# posterior_dist %>%
#   reshape2::melt() %>%
#   ggplot(aes(x = value)) +
#   geom_density() +
...
posterior_dist <- read.csv("../data/posterior_co_2020-04-14.csv")[-1,] %>% burn_n_thin_draws(jump = 350, burn_at = 1)
# posterior_dist %>%
#   reshape2::melt() %>%
#   ggplot(aes(x = value)) +
#   geom_density() +
