...
coefs_sampler2 <- function(coefs, multiplier){
  # m = diag(x = length(coefs)) * c(0.0040710324,0.0016390232,0.0011715054,0.0015996653,
  #                                 0.0015470993,0.0014420520,0.0018035758,0.0004000704,
  #                                 0.0019140519,0.0016581918,0.0017412798,0.0021065395,
  #                                 0.0016047045,0.0016158744,0.0015963546,0.0018599707 )
  m = matrix(
    c(
